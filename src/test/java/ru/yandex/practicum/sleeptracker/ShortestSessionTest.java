...
public class ShortestSessionTest {
    ...
    static void sessionsList() {
        ...
        correctSession = new SleepingSession(
        ...
        sessions = List.of(
                ...
                new SleepingSession(LocalDateTime.of(2025, 10, 11, 23, 0),
    ...
    void findshortSession() {
        ShortestSession shortestSession = new ShortestSession();
        SleepAnalysisResult result = shortestSession.apply(sessions);
